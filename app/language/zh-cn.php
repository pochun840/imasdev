...
$text['ms_text'] = '毫秒';
$text['Automatic Speech_Setting_text'] = '人声语音识别设置'; 
...
$text['Voice_Playback_Sound_text'] ="语音播放声音";
...
$text['Bias_text'] = '偏差';
$text['Meter_text'] = '儀表';
$text['Adapter_type_text'] = '转接头类型';
$text['calibration_certificate_text'] = '校准证书';
$text['company_text'] = '奇力速工业股份有限公司';
$text['company_address_text'] = '台湾新北市新庄区化成路83号';
$text['tel_text'] = '电话';
$text['fax_text'] = '传真';
$text['max_val_text'] = '最大值';
$text['min_val_text'] = '最小值';
$text['avg_val_text'] = '平均值';
$text['Offset_val_text'] = '偏差';
$text['Tolerance_val_text'] = '容差';
$text['Standard_deviation_text'] = '标准差';
$text['3_Standard_deviation_text'] = '三倍标准差';
$text['Positive_Tolerance_text'] = '正容差';
$text['Negative_Tolerance_text'] = '负容差';
$text['Tested_by_text'] = '测试人员';
$text['Approved_by_text'] = '审核人员';
$text['Range_text'] = '范围';
