...
$text['ms_text'] = '毫秒';
$text['Automatic Speech_Setting_text'] = '人聲語音辨識設定'; 
...
$text['Voice_Playback_Sound_text'] ="語音撥放聲音";
...
$text['Standard_deviation_text'] = '標準差';
$text['3_Standard_deviation_text'] = '三倍標準差';
$text['Positive_Tolerance_text'] = '正容差';
$text['Negative_Tolerance_text'] = '負容差';
$text['Tested_by_text'] = '測試人員';
$text['Approved_by_text'] = '審核人員';
$text['Range_text'] = '範圍';
$text['Deviation_text'] = '偏差';
$text['Tool_Model_text'] = '工具型號 ';
$text['Serial_Number_text'] = '序列號';
$text['no_text'] = '編號';
//----------------------------------------------------------------------------------------------------------------
//扭力單位
