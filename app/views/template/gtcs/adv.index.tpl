                                ...
                                <div class="modal-force-overflow">
                                    <div style="padding-left: 5%; height: 300px">
                                        ...
                                        <div class="row t1">
                                            ...
                                            <div class="col-5 t2">
                                                <input type="text" id="program-name" class="form-control input-ms" value="Program-1" maxlength="" onkeyup="this.value=this.value.replace(/[^a-zA-Z0-9\u4E00-\u9FA5\-_\.\s]/g, '')">
                                            </div>
                                        </div>
                                        <div class="row t1">
                    ...
                    <form id="copy_Pro_form">
                        ...
                        <div style="padding-left: 20px;">
                            ...
                            <div class="row">
                                ...
                                <div class="col-5 t2">
                                    <input type="text" class="form-control" id="to_Program_name" onkeyup="this.value=this.value.replace(/[^a-zA-Z0-9\u4E00-\u9FA5\-_\.\s]/g, '')">
                                </div>
                            </div>
                        </div>
                    </form>
