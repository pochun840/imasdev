...
<div class="container-ms">
    ...
    <header>
        ...
        <input id ="current_program_id" value ="<?php echo $data['current_program_id'];?>">
    ...
    <!-- Virtual Message -->
    <div id="VirtualMessage" class="virtual-message" style="display: block; vertical-align: middle;">
        <div class="topnav">
        ...
        <div class="scrollbar-Message_text_s">
...
function initail() {
    ...
    current_program_id = '<?php echo $data['current_program_id'];?>';
                                        ...
                                        if (task) {
                                            ...
                                            if(task.img === '') {
                                                ...
                                                if (element) {
                                                    ...
                                                    element.className = 'scrollbar-Message_text_shrink';
                                                }
                                            }
...
<script>
    ...
    function save_result(data, fasten_status_new) {
        ...
        data.cc_program_id = current_program_id;
