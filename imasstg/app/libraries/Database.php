...
class Database
{
    ...
    public function __construct()
    {
        ...
        if( PHP_OS_FAMILY == 'Linux'){
            ...
            if( file_exists('/var/www/html/database/'.$data_db_name) ){
                ...
                $this->db_data = new PDO('sqlite:/var/www/html/database/default_data.db'); //local
            }
            ...
            $this->db_cc = new PDO('sqlite:../cc.db'); //local
        ...
        $this->db_cc->exec('set names utf-8'); 
    ...
    public function getDb_cc() {
        if ($this->db_cc instanceof PDO) {
            return $this->db_cc;
        }
    }
